...
public class Parameters {
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.CacherDansLesCoins"; //class given by name; is supposed to extends robotsimulator.Brain
