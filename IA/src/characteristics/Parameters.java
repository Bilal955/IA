...
public class Parameters {
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.CacherDansLesCoins2"; //class given by name; is supposed to extends robotsimulator.Brain
