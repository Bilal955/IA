...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.BrainMainCanevas"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final double teamAMainBotRadius = 50, //1 unit = 1mm, body radius
                             teamAMainBotFrontalDetectionRange = 200, //1 unit = 1mm, range of frontal sensor
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.CacherDansLesCoinsGauche"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.Vica"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.CacherDansLesCoinsDroite"; //class given by name; is supposed to extends robotsimulator.Brain
